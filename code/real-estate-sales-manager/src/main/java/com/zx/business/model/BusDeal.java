...
public class BusDeal extends PageVO {
     ...
     * @mbg.generated
     */
    public BusDeal(Integer id, Integer realEstateId, String realEstateName, Integer state, Integer customerId, String customerPhone, String customerName, Integer reportUserId, String reportUserPhone, String reportCompany, Date appointmentTime, Date reportTime, Date arriveTime, Date subscribeTime, Integer managerId, String managerPhone, String arriveCertifyPhotoPath, String subscribeMoney, String subscribeCommision, String subscribePhotoPahts, Date appointmentOperateTime, Date reportOperateTime, Date arriveOperateTime, Date subscribeOperateTime, Date createTime, Date updateTime) {
        this.id = id;
    ...
    public BusDeal(Integer id, Integer realEstateId, String realEstateName, Integer state, Integer customerId, String customerPhone, String customerName, Integer reportUserId, String reportUserPhone, String reportCompany, Date appointmentTime, Date reportTime, Date arriveTime, Date subscribeTime, Integer managerId, String managerPhone, String arriveCertifyPhotoPath, String subscribeMoney, String subscribeCommision, String subscribePhotoPahts, Date appointmentOperateTime, Date reportOperateTime, Date arriveOperateTime, Date subscribeOperateTime, Date createTime, Date updateTime, BusRealEstate busRealEstate, BusCustomer busCustomer, BusUser reportUser, BusUser manager) {
        this.id = id;
        this.realEstateId = realEstateId;
        this.realEstateName = realEstateName;
        this.state = state;
