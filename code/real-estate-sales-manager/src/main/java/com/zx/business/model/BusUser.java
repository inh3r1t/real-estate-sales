...
public class BusUser extends PageVO {
    ...
    public BusUser(Integer id, String openId, String userName, String passwd, String phoneNum, String pollCode, Integer roleId, Integer companyId, String companyName, Date createTime, Date updateTime, BusRole busRole) {
        this.id = id;
        this.openId = openId;
        this.userName = userName;
        this.passwd = passwd;
