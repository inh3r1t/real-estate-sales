...
public class BusUser {
     ...
     * @mbg.generated
     */
    public BusUser(Integer id, String userName, String passwd, String phoneNum, String pollCode, Integer roleId, Integer companyId, String companyName, Date createTime, Date updateTime) {
        this.id = id;
